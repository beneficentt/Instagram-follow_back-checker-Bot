A sA script using Telegram's bot to check the follow-back status on Instagram's accounts. Before using the script first make a ".env" file containing the following parts:
